...
;;;Start test cases for problem 6
(define y 3)
; expect y
(define (function x) x)
; expect function
...
(square 3)
; expect 9
;;;End test cases for problem 6

;;;Start test cases for problem 7
(quote Goodbye)
; expect goodbye
'(list 33 36)
; expect (list 33 36)
...
'(cdr (1 2))
; expect (cdr (1 2))
;;;End test cases for problem 7

;;;Start test cases for problem 8
(begin (+ 2 3) (+ 1 2))
; expect 3
(define x (begin (- 1 2)))
;expect x
(eval (define x (begin (- 1 2))))
;expect -1
(begin (print 3) '(+ 2 3))
;expect (+ 2 3)
;;;End test cases for problem 8

;;;Start test cases for problem 9
(lambda (x y z) (* x (+ y z)))
;expect (lambda (x y z) (* x (+ y z)))
(define lamb ((lambda (e f) (list f e)) 3 5))
;expect lamb
lamb
;expect (5 3)
((lambda (harry potter) (if (= harry potter) harry 0)) 0 7)
;expect 0
;;;End test cases for problem 9

;;;Start test cases for problem 10
(define (triple x) (* 3 x))
; expect triple
scm> triple
; expect (lambda (x) (* 3 x))
...
(factorial 4)
; expect 24
(define (minimum x y) (if (> x y) y x))
; expect minimum
(minimum 43 34)
; expect 34
;;;End test cases for problem 10

;;;Start test cases for problem 13
(and)
; expect #t
(and 3 4 (* 3 2))
; expect 6
(and 7 (+ 3 4) (/ 3 3))
; expect 1
(and False False True 3 (/ 1 0) (/ 1 0))
; expect #f
(or)
; expect #f
(or (/ 10 0) 2 1) 
...
(or False (- 1 1) 10) 
; expect 0
(or 10 True (/ 1 0))  ; short-circuiting behavior of or
;expect 10
;;;End test cases for problem 13


;;;Start test cases for problem 14
(cond ((= 4 3) '1)
      ((= 4 4) '2)
      (else '3))
; expect 2
...
;;;End test cases for problem 14

;;;Start test cases for problem 15
(define y 5)
; expect y
(define k 'used)
; expect k
...
;;;End test cases for problem 15

;;;Start test cases for problem 16
(define f (mu (a b) (* a b)))
; expect f
(define g (lambda (j k) (f (+ j k) 2)))
; expect g
(g 3 7)
; expect 20

;;;End test cases for problem 16
; END PROBLEM 0

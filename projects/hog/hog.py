...
def free_bacon(score):
    ...
    return abs(first_digit - second_digit) + 2
    # END PROBLEM 2
    ...
    def say(score0, score1):
        if who == 0:
            if score0 - previous_score > previous_high and score0 - previous_score == 1:
                print(score0 - previous_score, 'point! That\'s the biggest gain yet for Player', who)
                ...
                print(score0 - previous_score, 'points! That\'s the biggest gain yet for Player', who)
                return announce_highest(who, score0 - previous_score, score0)
            else:
                return announce_highest(who, previous_high, score0)
        if who == 1:
            if score1 - previous_score > previous_high and score1 - previous_score == 1:
                print(score1 - previous_score, 'point! That\'s the biggest gain yet for Player', who)
                ...
                print(score1 - previous_score, 'points! That\'s the biggest gain yet for Player', who)
                return announce_highest(who, score1 - previous_score, score1)
            else:
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    i, maximum = 1, 0
    while i <= 10:
        f = make_averaged(roll_dice, num_samples)
        if f(i, dice) > maximum:
            maximum = f(i, dice)
            maximum_roll = i
        i = i + 1
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    if free_bacon(opponent_score) >= margin or (is_swap(new_score, opponent_score) and new_score < opponent_score):
        return 0
    else:
        return num_rolls  # Replace this statement
    # END PROBLEM 11
